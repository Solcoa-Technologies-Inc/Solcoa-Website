        ...
        <section className="relative min-h-screen pb-32 max-w-2xl mx-auto">
          <div className="mt-24 font-['Manrope'] font-medium tracking-tighter">
            ...
            <div>
              ...
              <blockquote className="pl-8 py-2 border-l-4 text-2xl md:text-3xl font-semibold border-blue-neo/60 mt-8 text-white/75">
              ...
              <blockquote className=" pl-8 py-2 border-l-4 border-blue-neo/60 mt-8 text-2xl md:text-3xl font-semibold text-white/75">
                Our domestic rare earth output remains negligible.{" "}
                <Pg className="font-black bg-blue-neo/90">
              ...
              <div className="mt-16 mb-16">
                <div className="border-b pb-4">
                  <h3 className="text-5xl font-bold font-serif">
                    <Pg className="bg-blue-neo">Sol</Pg>
                    ve et <Pg className="bg-blue-neo">coa</Pg>
                    gula
                  </h3>
...
function Pg({
  ...
  return (
    <GradientText className={cn("from-blue-neo/90 to-blue-neo/60", className)}>
      <span>{children}</span>
    </GradientText>
  );
}
